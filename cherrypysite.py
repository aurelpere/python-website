"""
this is a cherrypy website site.py
"""
#!/usr/bin/python3
# coding: utf-8
import cherrypy
...
def launch_website():
    "initialize cherrypy website server"
    site = MonSiteWeb()
    cherrypy.config.update({"environment": "production",
                            "log.screen": True,
                            "log.error_file": "./logerrors",
    ...
    return cherrypy.quickstart(site, config=conf)
